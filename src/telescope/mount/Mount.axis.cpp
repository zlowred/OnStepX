...
#ifdef AXIS1_RMD_PRESENT
  const RMDDriverSettings RMDDriverSettingsAxis1 = {};
  RMDMotor motor1(1, &RMDDriverSettingsAxis1);
#endif
...
const AxisSettings SettingsAxis1 = {AXIS1_STEPS_PER_DEGREE*RAD_DEG_RATIO, AXIS1_REVERSE, {degToRadF(AXIS1_LIMIT_MIN), degToRadF(AXIS1_LIMIT_MAX)}, siderealToRad(TRACK_BACKLASH_RATE), AXIS1_REDUCTION_RATIO};
...
#ifdef AXIS2_RMD_PRESENT
  const RMDDriverSettings RMDDriverSettingsAxis2 = {};
  RMDMotor motor2(2, &RMDDriverSettingsAxis2);
#endif
...
const AxisSettings SettingsAxis2 = {AXIS2_STEPS_PER_DEGREE*RAD_DEG_RATIO, AXIS2_REVERSE, {degToRadF(AXIS2_LIMIT_MIN), degToRadF(AXIS2_LIMIT_MAX)}, siderealToRad(TRACK_BACKLASH_RATE), AXIS2_REDUCTION_RATIO};
