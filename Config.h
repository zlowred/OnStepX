...
#define SERIAL_A_BAUD_DEFAULT      921600 //   9600, n. Where n=9600,19200,57600,115200,230400,460800 (common baud rates.)    Infreq
...
#define SERIAL_C_BAUD_DEFAULT      921600 //    OFF, n. Baud rate as above. See (src/pinmaps/) for Serial port assignments.   Infreq
...
#define AXIS1_DRIVER_MODEL            RMD //    OFF, Enter motor driver model (above) in both axes to activate the mount.    <-Often

// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ 
#define AXIS1_STEPS_PER_DEGREE     100000 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_REDUCTION_RATIO      2601.0 //    Axis 1 reduction ratio.
...
#define AXIS2_DRIVER_MODEL            RMD //    OFF, Enter motor driver model (above) in both axes to activate the mount.    <-Often

// If runtime axis settings are enabled changes in the section below will be ignored (disable in SWS or by wiping NV/EEPROM):
// \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/ \/
#define AXIS2_STEPS_PER_DEGREE     100000 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS2_REDUCTION_RATIO      2601.0 //    Axis 2 reduction ratio.                                          
...
#define AXIS3_DRIVER_MODEL        TMC5160 //    OFF, Enter motor driver model (above) to activate the rotator.                Option
...
#define AXIS4_DRIVER_MODEL        TMC5160 //    OFF, Enter motor driver model (above) to activate the focuser.                Option
